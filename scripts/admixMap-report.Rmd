...
eigval %>% mutate(id = row_number()) %>% ggplot(aes(x = id, y = V1)) + geom_bar(stat="identity") + ylab("Eigenvalue") + xlab("")
```

PC plots:
```{r plink-pcplots, fig.height = 4, fig.width = 4, fig.cap = "Pairwise PC plots for the number of PCs used in GWAS", warning=FALSE, message=FALSE}
